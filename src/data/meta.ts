...
export const COSMETICS: CosmeticDef[] = [
  { id: 'goggles-base', name: 'Signal chevron', slot: 'goggles', subtitle: 'Starter gold', unlock: 'start' },
  ...
  { id: 'hoodie-base', name: 'Signal suit', slot: 'hoodie', subtitle: 'Bone hood', unlock: 'start' },
  { id: 'hoodie-court', name: 'Lane suit', slot: 'hoodie', subtitle: 'Terracotta', unlock: 'flight-complete' },
  { id: 'hoodie-signal', name: 'Signal bone', slot: 'hoodie', subtitle: 'Locked look', unlock: 'different-look' },
  { id: 'kicks-base', name: 'Signal boots', slot: 'kicks', subtitle: 'Bone / navy', unlock: 'start' },
  ...
  { id: 'paint-volt', name: 'Muted Yellow', slot: 'paint', subtitle: 'Harbor RS body', unlock: 'start' },
